...
-f [number of females in the last generation used for phenotypic selection]
...
for ($i = 0; $i < @OldFemaleXAoA; $i++){
  ...
  for ($j = 0; $j < @positions; $j++){
    while ( ($break < @{$OldFemaleXAoA[$i]} ) && ($OldFemaleXAoA[$i][$break] <= $positions[$j])){
      $anc++;
      $break++;
    }
    if ( ($anc % 2) == 1){
...
for ($i = 0; $i < @OldFemale2AoA; $i++){
  ...
  $break = 0;
  for ($j = 0; $j < @positions; $j++){
    while ( ($break < @{$OldFemale2AoA[$i]} ) && ($OldFemale2AoA[$i][$break] <= $positions[$j])){
      $anc++;
      $break++;
    }
    if ( ($anc % 2) == 1){
...
for ($i = 0; $i < @OldFemale3AoA; $i++){
  $anc = 1;
  $break = 0;
  for ($j = 0; $j < @positions; $j++){
    while ( ($break < @{$OldFemale3AoA[$i]} ) && ($OldFemale3AoA[$i][$break] <= $positions[$j])){
      $anc++;
      $break++;
    }
    if ( ($anc % 2) == 1){
